...
suite is 197 tests and takes about six minutes there: 188 pass, 8 skip for want
of a display, and one -- the checkpoint-determinism check -- currently fails on
that adapter, on `main` as much as on any branch, and is not yet explained.
